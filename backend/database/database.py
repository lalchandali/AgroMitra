...
DEFAULT_DATABASE_URL = "postgresql://postgres:agromitra123@localhost:5432/agromitra_db"
...
if not raw_database_url or raw_database_url in PLACEHOLDER_URLS or "user:password" in raw_database_url or "host:port" in raw_database_url:
    if raw_database_url:
        print(
            "  ⚠️ Ignoring placeholder DATABASE_URL environment variable.",
            "Using the local PostgreSQL default connection instead.",
        )
