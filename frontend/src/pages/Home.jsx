        ...
        {weather && !weatherLoading && !weatherError && (
          weather.has_alert ? (
            <div className="alert alert-warning" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', borderLeft: '6px solid var(--orange)' }}>
              ...
              <span className="badge badge-orange" style={{ whiteSpace: 'nowrap' }}>{weather.district} • {weather.temperature_c}°C</span>
            </div>
          ) : (
            <div className="alert alert-success" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', borderLeft: '6px solid var(--green)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <span style={{ fontSize: '24px' }}>☀️</span>
                <div>
